...
workdir="/Users/shengwei/GitHub/Tricho-Transcriptomics/differential-expression-analysis"
setwd(workdir)
...
library(BiocManager)
#BiocManager::install(c('edgeR', 'DESeq2', 'NOISeq', 'dendextend', 'phyloseq', 'apeglm', 'pheatmap', 'carData'))
library("edgeR")
library("NOISeq")
library("DESeq2")
library("dendextend")
